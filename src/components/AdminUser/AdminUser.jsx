    ...
    const renderAction = () => {
        return (
            <div>
                ...
                <EditOutlined  style={{ color: 'orange', fontSize: 25, cursor: "pointer" }} onClick={handleDetailsUser}/>
            </div>
        )
    }
            ...
            <ModalComponent forceRender title="Tạo sản phẩm" open={isModalOpen} onCancel={handleCancel} footer={null}>
                <Loading isPending={isPending}>
                    ...
                    >
                        ...
                        >
                            <InputComponent value={stateUser.name} onChange={handleInputChange} name='name'/>
                        </Form.Item>
                        <Form.Item
                            label="Email"
                            name="email"
                        ...
                        >
                            <InputComponent value={stateUser.email} onChange={handleInputChange} name='email'/>
                        </Form.Item>
                        <Form.Item
                            label="Admin"
                            name="isAdmin"
                        ...
                        >
                            <Switch checked={stateUser.isAdmin} onChange={(checked) => setStateUser((prev) => ({ ...prev, isAdmin: checked }))} name='isAdmin'/>
                        </Form.Item>
                        <Form.Item
                            label="Phone"
                            name="phone"
                        ...
                        >
                            <InputComponent value={stateUser.phone} onChange={handleInputChange} name='phone'/>
                        </Form.Item>
                        <Form.Item
                            label="address"
                            name="address"
                        >
                            <InputComponent value={stateUserDetails.address} onChange={handleInputChange} name='address'/>
                        </Form.Item>
                        <Form.Item
                            label="Avatar"
                            name="avatar"
                ...
                <Form
                    ...
                    >
                        <Form.Item
                            ...
                            rules={[{ required: true, message: 'Please input your name!' }]}
                        >
                            <InputComponent value={stateUserDetails.name} onChange={handleInputChangeDetails} name='name'/>
                        </Form.Item>
                        <Form.Item
                            label="Email"
                            name="email"
                            rules={[{ required: true, message: 'Please input your email!' }]}
                        >
                            <InputComponent value={stateUserDetails.sku} onChange={handleInputChangeDetails} name='sku'/>
                        </Form.Item>
                        <Form.Item
                            label="Phone"
                            name="phone"
                            rules={[{ required: true, message: 'Please input your phone!' }]}
                        >
                            <InputComponent value={stateUserDetails.type} onChange={handleInputChangeDetails} name='type'/>
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            name="address"
                        >
                            <InputComponent value={stateUserDetails.address} onChange={handleInputChangeDetails} name='address'/>
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            valuePropName="checked"
                        >
                            <Switch checked={stateUserDetails.isAdmin} onChange={(checked) => setStateUserDetails((prev) => ({ ...prev, isAdmin: checked }))} name='isAdmin'/>
                        </Form.Item>
