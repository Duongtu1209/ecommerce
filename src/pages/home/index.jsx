...
const Home = () => {
    ...
    return (
        <>
            ...
            <div id="container" style={{backgroundColor: '#efefef', padding: '0 120px', height: 1000}}>
                <SliderComponent arrImages={[blackFriday, muathu, lotus, sofa]}/>
                <div style={{marginTop: 20, display: 'flex', alignContent: 'center', gap: 32.5, flexWrap: 'wrap' }}>
                    <CardComponent/>
                    <CardComponent/>
                    <CardComponent/>
                    <CardComponent/>
                ...
                <div style={{ width: '100%', display: 'flex', justifyContent: 'center', marginTop: 10}}>
                    <WrapperButtonMore 
                        textbutton="Xem thêm" 
                        type="outline" 
                        styleButton={{border: "1px solid rgb(11, 116, 229)", color: `rgb(11, 116, 229)`, width: 240, height: 38, borderRadius: 4}}
